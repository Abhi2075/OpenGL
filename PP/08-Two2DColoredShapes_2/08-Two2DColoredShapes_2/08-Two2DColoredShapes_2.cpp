...
void initilize(void)
{
	...
	{ 
		rectangleVertex,rectangleVertex,rectangleVertex,
		-rectangleVertex,rectangleVertex,rectangleVertex,
		-rectangleVertex,-rectangleVertex,rectangleVertex,
		rectangleVertex,-rectangleVertex,rectangleVertex,
	};
	...
	glVertexAttribPointer(ADS_ATTRUBUTE_VERTEX_Position, 3, GL_FLOAT, GL_FALSE, 0, NULL);
	glEnableVertexAttribArray(ADS_ATTRUBUTE_VERTEX_Position);
	glVertexAttrib3f(ADS_ATTRUBUT_COLORS,1.0f,0.0f,0.0f); //This method only use when object has only one color This is not useful for Triangle
	glBindBuffer(GL_ARRAY_BUFFER, 0);
