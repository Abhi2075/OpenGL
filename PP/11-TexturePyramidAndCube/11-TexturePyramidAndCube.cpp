...
void initilize(void)
{
	...
	GLfloat PraymedVertex = 1.0f;
	GLfloat CubeVertex = 1.0f;
	GLfloat Zero = 0.0f;
	//PrymidglTexCoord2f
	GLfloat PyramidTopX = 0.25f;
	GLfloat PyramidTopY = 1.0f;
	GLfloat PyramidRightX = 1.0f;
	GLfloat PyramidRightY = 0.0f;
	GLfloat PyramidLeftX = 0.0f;
	GLfloat PyramidLeftY = 0.0f;
	//CubeglTexCoord2f
	...
	{
		//Front
		Zero,PraymedVertex,Zero, //apex
		-PraymedVertex,-PraymedVertex,PraymedVertex, //left-bottom
		PraymedVertex,-PraymedVertex,PraymedVertex, //right bottom
	...
	{ 
		//Front
		PyramidTopX, PyramidTopY, //apex
		PyramidLeftX, PyramidLeftY, //left-bottom
		PyramidRightX, PyramidRightY, //right bottom
...
void display(void)
{
	...
	glBindTexture(GL_TEXTURE_2D, Stone_Texture);//Bind Texture
