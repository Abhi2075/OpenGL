...
void initilize(void)
{
	...
	GLfloat pyramidVertex = 1.0f;
	GLfloat cubeVertex = 1.0f;
	GLfloat Zero = 0.0f;
	GLfloat pyramidColor = 1.0f;
	GLfloat cubeColor =  1.0f;

	const GLfloat triangleVertices[] =
	{
		//Front
		Zero,pyramidVertex,Zero, //apex
		-pyramidVertex,-pyramidVertex,pyramidVertex, //left-bottom
		pyramidVertex,-pyramidVertex,pyramidVertex, //right bottom
	...
	{ 
		//Front
		pyramidColor, Zero, Zero, pyramidColor, //apex
		Zero, pyramidColor, Zero, pyramidColor, //left-bottom
		Zero, Zero, pyramidColor, pyramidColor, //right bottom

		//Right
		Zero, Zero, pyramidColor, pyramidColor, //apex
		pyramidColor, Zero, Zero, pyramidColor, //left-bottom
		Zero, pyramidColor, Zero, pyramidColor, //right bottom

		//Back
		Zero, pyramidColor, Zero, pyramidColor, //apex
		Zero, Zero, pyramidColor, pyramidColor, //left-bottom
		pyramidColor, Zero, Zero, pyramidColor, //right bottom
...
void display(void)
{
	...
	modelViewMatrix = modelViewMatrix * vmath::rotate(Rangle, 0.0f, 1.0f, 0.0f);
	modelViewMatrix = modelViewMatrix * vmath::rotate(Rangle, 0.0f, 0.0f, 1.0f);
