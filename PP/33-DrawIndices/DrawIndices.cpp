...
void initilize(void)
{
	...
	{ 
		...
		//AS////Back
		//AS//cubeVertex,cubeVertex,-cubeVertex,
		//AS//-cubeVertex,cubeVertex,-cubeVertex,
		//AS//-cubeVertex,-cubeVertex,-cubeVertex,
		//AS//cubeVertex,-cubeVertex,-cubeVertex,
		//AS//
	...
	//AS//glBindBuffer(GL_ELEMENT_ARRAY_BUFFER, 0); //in index based vbo never unbind
...
void display(void)
{
	...
	modelViewMatrix = vmath::translate(0.0f, 0.0f, -6.0f); //AS// *vmath::rotate(Rangle, 1.0f, 0.0f, 0.0f);
	//AS//modelViewMatrix = modelViewMatrix * vmath::rotate(Rangle, 0.0f, 1.0f, 0.0f);
	//AS//modelViewMatrix = modelViewMatrix * vmath::rotate(Rangle, 0.0f, 0.0f, 1.0f);
	...
	//AS//glDrawArrays(GL_TRIANGLE_FAN, 0, 4); //0-4 (each with its x,y,z,w) vertices in cubevertices array
	//AS//glDrawArrays(GL_TRIANGLE_FAN, 4, 4); //4-4 (each with its x,y,z,w) vertices in cubevertices array
	//AS//glDrawArrays(GL_TRIANGLE_FAN, 8, 4); //8-4 (each with its x,y,z,w) vertices in cubevertices array
	//AS//glDrawArrays(GL_TRIANGLE_FAN, 12, 4);//12-4 (each with its x,y,z,w) vertices in cubevertices array
	//AS//glDrawArrays(GL_TRIANGLE_FAN, 16, 4);//16-4 (each with its x,y,z,w) vertices in cubevertices array
	//AS//glDrawArrays(GL_TRIANGLE_FAN, 20, 4);//20-4 (each with its x,y,z,w) vertices in cubevertices array
