...
void initilize(void)
{
	...
	glShaderSource(gGeometryShaderObject, 1, (const GLchar **)&tessellationControlShaderSourceCode, NULL);
...
void display(void)
{
	...
	translateMatrix = translate(0.0f, 0.0f, -5.0f); // This step for begin after prectise multiply directly
