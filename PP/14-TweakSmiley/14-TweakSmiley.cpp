...
void initilize(void)
{
	...
	//AS////CubeglTexCoord2f
	//AS//GLfloat CubeLeftXBottom = 0.0f;
	//AS//GLfloat CubeLeftYBottom = 0.0f;
	//AS//GLfloat CubeRightXBottom = 1.0f;
	//AS//GLfloat CubeRightYBottom = 0.0f;
	//AS//GLfloat CubeLeftXTop = 0.0f;
	//AS//GLfloat CubeLeftYTop = 1.0f;
	//AS//GLfloat CubeRightXTop = 1.0f;
	//AS//GLfloat CubeRightYTop = 1.0f;
	...
	//AS//const GLfloat cubeTexCoords[] = 
	//AS//{
	//AS//	//Front
	//AS//	CubeRightXTop, CubeRightYTop,
	//AS//	CubeLeftXTop, CubeLeftYTop,
	//AS//	CubeLeftXBottom, CubeLeftYBottom,
	//AS//	CubeRightXBottom, CubeRightYBottom,
	//AS//};
...
void display(void)
{
	...
	{
			//Front
		cubeTexCoords[0] = CubeRightXTop;
		cubeTexCoords[1] = CubeRightYTop;
		cubeTexCoords[2] = CubeLeftXTop;
		cubeTexCoords[3] = CubeLeftYTop;
		cubeTexCoords[4] = CubeLeftXBottom;
		cubeTexCoords[5] = CubeLeftYBottom;
		cubeTexCoords[6] = CubeRightXBottom;
		cubeTexCoords[7] = CubeRightYBottom;
	}

	else if (PressedInteger == 2)
	{
		cubeTexCoords[0] = CubeRightXTop / 2;
		cubeTexCoords[1] = CubeRightYTop / 2;
		cubeTexCoords[2] = CubeLeftXTop / 2;
		cubeTexCoords[3] = CubeLeftYTop / 2;
		cubeTexCoords[4] = CubeLeftXBottom / 2;
		cubeTexCoords[5] = CubeLeftYBottom / 2;
		cubeTexCoords[6] = CubeRightXBottom / 2;
		cubeTexCoords[7] = CubeRightYBottom / 2;
	}

	else if (PressedInteger == 3)
	{
	
		cubeTexCoords[0] = CubeRightXTop + 1;
		cubeTexCoords[1] = CubeRightYTop + 1;
		cubeTexCoords[2] = CubeLeftXTop;
		cubeTexCoords[3] = CubeLeftYTop +1;
		cubeTexCoords[4] = CubeLeftXBottom;
		cubeTexCoords[5] = CubeLeftYBottom;
		cubeTexCoords[6] = CubeRightXBottom +1;
		cubeTexCoords[7] = CubeRightYBottom;
	}

	else if (PressedInteger == 4)
	{
		cubeTexCoords[0] = CubeRightXTop / 2;
		cubeTexCoords[1] = CubeRightXTop / 2;
		cubeTexCoords[2] = CubeRightXTop / 2;
		cubeTexCoords[3] = CubeRightXTop / 2;
		cubeTexCoords[4] = CubeRightXTop / 2;
		cubeTexCoords[5] = CubeRightXTop / 2;
		cubeTexCoords[6] = CubeRightXTop / 2;
		cubeTexCoords[7] = CubeRightXTop / 2;
	}

	glBindBuffer(GL_ARRAY_BUFFER, gVbo_Texture_Cube);
	glBufferData(GL_ARRAY_BUFFER, 4 * 2 * sizeof(GLfloat), cubeTexCoords, GL_DYNAMIC_DRAW);
	glVertexAttribPointer(ADS_ATTRIBUTE_TEXTURE0, 2, GL_FLOAT, GL_FALSE, 0, NULL);
	glEnableVertexAttribArray(ADS_ATTRIBUTE_TEXTURE0);
	//glBindBuffer(GL_ARRAY_BUFFER, 0);
